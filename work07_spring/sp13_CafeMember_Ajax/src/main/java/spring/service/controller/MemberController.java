...
public class MemberController {
	...
	//비동기 요청 추가...
	@RequestMapping("idEsixt.do")
	public String idEsixt(String id, Model model) throws Exception{
		String rid=memberDAO.idExist(id);
		boolean check = false; //디비에 id 가 존재안하면 check는 false
		if(rid!=null)check = true; //디비에 id 가 존재하면 check는 true
